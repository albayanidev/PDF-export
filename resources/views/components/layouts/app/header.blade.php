...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <a href="{{ route('dashboard') }}" class="flex items-center ml-2 mr-5 space-x-2 lg:ml-0" wire:navigate>
                <x-app-logo />
            </a>
        ...
        <flux:sidebar stashable sticky class="border-r lg:hidden border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <a href="{{ route('dashboard') }}" class="flex items-center ml-1 space-x-2" wire:navigate>
                <x-app-logo />
            </a>
